...
public class DefaultBot extends AbilityBot {
  ...
  public DefaultBot(TelegramClient telegramClient, String username, DBContext db) {
    super(telegramClient, username, db);
  }

  public DefaultBot(TelegramClient telegramClient, String username, DBContext db, AbilityToggle toggle) {
    super(telegramClient, username, db, toggle);
  }
