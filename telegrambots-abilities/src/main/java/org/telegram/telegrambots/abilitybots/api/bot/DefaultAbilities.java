...
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_BAN_FAIL;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_BAN_SUCCESS;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_CLAIM_FAIL;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_CLAIM_SUCCESS;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_COMMANDS_NOT_FOUND;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_DEMOTE_FAIL;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_DEMOTE_SUCCESS;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_PROMOTE_FAIL;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_PROMOTE_SUCCESS;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_RECOVER_ERROR;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_RECOVER_FAIL;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_RECOVER_MESSAGE;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_RECOVER_SUCCESS;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_UNBAN_FAIL;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.ABILITY_UNBAN_SUCCESS;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityMessageCodes.USER_NOT_FOUND;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityUtils.addTag;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityUtils.escape;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityUtils.getLocalizedMessage;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityUtils.shortName;
import static org.telegram.telegrambots.abilitybots.api.util.AbilityUtils.stripTag;
...
public final class DefaultAbilities implements AbilityExtension {
  ...
  public Ability reportCommands() {
    return builder()
        ...
        .input(0)
        .action(ctx -> {
          String commands = bot.getAbilities().values().stream()
  ...
  public Ability commands() {
    return builder()
        ...
        .action(ctx -> {
          ...
          ListMultimap<Privacy, String> abilitiesPerPrivacy = bot.getAbilities().values().stream()
              .map(ability -> {
                String name = ability.name();
                String info = ability.info();
  ...
  public Ability reportStats() {
    return builder()
        ...
        .input(0)
        .action(ctx -> {
          String stats = bot.getStats().entrySet().stream()
              .map(entry -> format("%s: %d", entry.getKey(), entry.getValue().hits()))
    ...
    return builder()
        ...
        .action(ctx -> {
          ...
          try (PrintStream printStream = new PrintStream(backup)) {
            ...
            bot.telegramClient.execute(SendDocument.builder()
