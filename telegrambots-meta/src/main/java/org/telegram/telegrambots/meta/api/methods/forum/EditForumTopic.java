...
public class EditForumTopic extends BotApiMethodBoolean {
    ...
    public static abstract class EditForumTopicBuilder<C extends EditForumTopic, B extends EditForumTopicBuilder<C, B>> extends BotApiMethodBooleanBuilder<C, B> {
        @Tolerate
        public EditForumTopicBuilder<C, B> chatId(@NonNull Long chatId) {
            this.chatId = chatId.toString();
            return this;
        }
    }
