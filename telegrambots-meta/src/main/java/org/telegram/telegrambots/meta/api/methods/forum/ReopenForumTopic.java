...
public class ReopenForumTopic extends BotApiMethodBoolean {
    ...
    public static abstract class ReopenForumTopicBuilder<C extends ReopenForumTopic, B extends ReopenForumTopicBuilder<C, B>> extends BotApiMethodBooleanBuilder<C, B> {
        @Tolerate
        public ReopenForumTopicBuilder<C, B> chatId(@NonNull Long chatId) {
            this.chatId = chatId.toString();
            return this;
        }
    }
